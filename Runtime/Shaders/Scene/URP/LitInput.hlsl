...
#define _SpecColor              UNITY_ACCESS_DOTS_INSTANCED_PROP(float4, _SpecColor)
#define _EmissionColor          UNITY_ACCESS_DOTS_INSTANCED_PROP(float4, _EmissionColor)
#define _Cutoff                 UNITY_ACCESS_DOTS_INSTANCED_PROP(float, _Cutoff)
#define _Smoothness             UNITY_ACCESS_DOTS_INSTANCED_PROP(float, _Smoothness)
#define _Metallic               UNITY_ACCESS_DOTS_INSTANCED_PROP(float, _Metallic)
#define _BumpScale              UNITY_ACCESS_DOTS_INSTANCED_PROP(float, _BumpScale)
#define _Parallax               UNITY_ACCESS_DOTS_INSTANCED_PROP(float, _Parallax)
#define _OcclusionStrength      UNITY_ACCESS_DOTS_INSTANCED_PROP(float, _OcclusionStrength)
#define _ClearCoatMask          UNITY_ACCESS_DOTS_INSTANCED_PROP(float, _ClearCoatMask)
#define _ClearCoatSmoothness    UNITY_ACCESS_DOTS_INSTANCED_PROP(float, _ClearCoatSmoothness)
#define _DetailAlbedoMapScale   UNITY_ACCESS_DOTS_INSTANCED_PROP(float, _DetailAlbedoMapScale)
#define _DetailNormalMapScale   UNITY_ACCESS_DOTS_INSTANCED_PROP(float, _DetailNormalMapScale)
#define _Surface                UNITY_ACCESS_DOTS_INSTANCED_PROP(float, _Surface)
#endif
