...
void DepthNormalsFragment(Varyings input, out half4 outNormalWS : SV_Target0)
{
    ...
    Alpha(SampleAlbedoAlpha(input.uv, TEXTURE2D_ARGS(_BaseMap, sampler_BaseMap)).a, _BaseColor, Get_Cutoff());
        ...
        //#if defined(_NORMALMAP) || defined(_DETAIL)
            ...
            float3 normalTS = SampleNormal_Scene(uv, TEXTURE2D_ARGS(_BumpMap, sampler_BumpMap), Get_BumpScale());
